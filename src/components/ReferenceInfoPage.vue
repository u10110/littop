...
const pages = {
  activity: { kicker: 'СООБЩЕСТВО', title: 'Новости и активность', lead: 'Публикации, конкурсы, литературные встречи и всё важное в сообществе.', type: 'feed', items: [
